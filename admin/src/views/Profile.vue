<template>
  <div>
    <v-card>
      ...
      <v-toolbar flat>
        <v-toolbar-title>Mon Profile</v-toolbar-title>
      </v-toolbar>
      <v-tabs vertical>
        <v-tab>
          <v-icon left>mdi-account</v-icon>Mes informations
        </v-tab>
        <v-tab>
          <v-icon left>mdi-lock</v-icon> Changer password
        </v-tab>
        <v-tab>
          <v-icon left>edit</v-icon>Editer Mon Profile
        </v-tab>
