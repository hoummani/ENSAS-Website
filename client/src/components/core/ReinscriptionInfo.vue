<template>
  <div class="ma-4">
    ...
    <v-divider></v-divider>
    <v-layout class="my-3">
      <v-flex xs12 sm12 md12 lg12 offset-lg3 offset-md3 offset-sm3 offset-xs3>
        <v-btn color="primary">Commenser l'inscription</v-btn>
        <v-btn color="secondary">Consulter votre profile</v-btn>
      </v-flex>
    </v-layout>
  </div>
</template>
